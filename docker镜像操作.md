...
```
[root@VM-0-12-centos ~]# docker pull ubuntu:18.04
...
```
[root@VM-0-12-centos ~]# docker image ls ubuntu
REPOSITORY   TAG       IMAGE ID       CREATED       SIZE
ubuntu       18.04     3339fde08fc3   2 weeks ago   63.3MB
```
...
```
[root@VM-0-12-centos ~]# docker image ls ubuntu:18.04
REPOSITORY   TAG       IMAGE ID       CREATED       SIZE
ubuntu       18.04     3339fde08fc3   2 weeks ago   63.3MB
```
...
```
[root@VM-0-12-centos ~]# docker image rm --help
